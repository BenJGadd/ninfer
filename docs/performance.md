...
| Qwen3.5-9B / `groupwise-int` (local port) | [8K–256K](performance/qwen3.5-9b.md#no-speculation-context-profile) | [MTP3](performance/qwen3.5-9b.md#single-request-speculative-decode) | Not published | Not published |
