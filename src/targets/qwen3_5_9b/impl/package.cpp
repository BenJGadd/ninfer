...
// Qwen3.5-9B model-card presets ("general tasks" rows): thinking and instruct modes both
// recommend presence_penalty 1.5.
...
Package::WeightsProfile Package::resolve_weights(const artifact::ArtifactIdentity& identity) {
    if (identity.model_id == model_id && identity.weights_id == "groupwise-int") {
        return WeightsProfile::Qwen35GroupwiseInt;
    }
