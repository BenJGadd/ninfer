...
namespace {
using Geometry = Nvfp4Geometry<4096, 8192>;
using Gemv =
...
// Qwen3.5-9B MTP input projection shape (docs/maintainer/qwen3.5-9b-port.md §8.2). A16 routes are n5120_k6144's;
...
const Nvfp4LinearShape kNvfp4N4096K8192{4096, 8192, launch_nvfp4_a16_chunks<32, select_a16>,
