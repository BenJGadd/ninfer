...
namespace {
using Geometry = Nvfp4Geometry<248320, 4096>;
using Gemv =
...
// Qwen3.5-9B output head shape (docs/maintainer/qwen3.5-9b-port.md §8.2). A16 routes are n5120_k6144's;
...
const Nvfp4LinearShape kNvfp4N248320K4096{248320, 4096, launch_nvfp4_a16_chunks<32, select_a16>,
